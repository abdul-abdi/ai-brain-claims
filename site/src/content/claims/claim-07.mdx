...
thread: "social"
date: "2026-05-09"
description: "Long-running multi-agent LLM systems develop functional theory-of-mind purely from interaction pressure, without explicit ToM training. Strong form structurally refuted: frozen weights → no gradient flow → 'growth' must be in-context accumulation, not new capability. Weak form confounded — pretraining-derived ToM elicited under loop conditions, not generated."
tags: ["theory-of-mind", "multi-agent", "emergence", "social-cognition"]
---
