...
date: "2026-05-09"
description: "There exists 'something it is like' to be an LLM performing chain-of-thought reasoning, operationalizable via IIT or GWT. Strong form (phenomenal consciousness) is unfalsifiable + empirically underdetermined. Weak form (functional signatures of consciousness theories) is partially supported but complicated by systematic CoT faithfulness failure."
tags: ["consciousness", "phenomenology", "cot", "iit", "gwt", "hard-problem"]
---
...
1. **Precautionary welfare posture is justified; strong phenomenal claims are not.** Birch's threshold-based precautionary framework is appropriate. The ~15% probability estimate is a reasonable uncertainty register, not a claim. Model welfare research should continue without asserting phenomenal consciousness.
...
- Tononi, G., Boly, M., Massimini, M., Koch, C. (2016). "Integrated information theory." _Nature Reviews Neuroscience_.
- Albantakis, L. et al. (2023). "Integrated information theory (IIT) 4.0." _PLOS Computational Biology_. PMC10581496.
- Butlin, P., Long, R., Chalmers, D. et al. (2023/2025). "Consciousness in Artificial Intelligence / Identifying indicators of consciousness in AI systems." arXiv:2308.08708; _Trends in Cognitive Sciences_ 2025.
- Chalmers, D.J. (1995). "Facing Up to the Problem of Consciousness." _Journal of Consciousness Studies_ 2: 200–19.
- Block, N. (1995). "On a confusion about a function of consciousness."
- Dehaene, S., Changeux, J.-P. (2011/2021). Global Neuronal Workspace hypothesis. PMC8770991.
- Frankish, K. (2016). "Illusionism as a Theory of Consciousness."
- Schwitzgebel, E. (2025). "AI and Consciousness: A Skeptical Overview." arXiv:2510.09858.
- Anthropic (2025). "Signs of introspection in large language models." anthropic.com/research/introspection.
- Anthropic (2026). "Emotion Concepts and their Function in a Large Language Model." transformer-circuits.pub/2026/emotions.
- Anthropic (2024). "Exploring model welfare." anthropic.com/research/exploring-model-welfare.
- Birch, J. (2024). _The Edge of Sentience: Risk and Precaution in Humans, Other Animals, and AI._ Oxford University Press.
- Manuvinakurike, R. et al. (2025). "Thoughts without Thinking." arXiv:2505.00875.
- Shang, W. (2026). "Theater of Mind for LLMs." arXiv:2604.08206.
- Nature (2025). "Adversarial testing of global neuronal workspace and integrated information theories."
