...
thread: "memory"
date: "2026-05-09"
description: "The single largest qualitative gap between LLM cognition and human cognition is the absence of an offline replay/consolidation phase analogous to sleep. Strong form is partially unfalsifiable; weak form (CLS-inspired replay closes some of the catastrophic-forgetting gap; REM-analog generative recomposition is the underexplored direction) is supported."
tags: ["sleep", "memory-consolidation", "continual-learning", "catastrophic-forgetting", "cls"]
---
...
- McClelland, McNaughton, O'Reilly (1995), _Psychological Review_ — CLS theory foundational paper
- Kumaran, Hassabis, McClelland (2016), _Trends in Cognitive Sciences_ — CLS theory updated for intelligent agents
- Diekelmann & Born (2010), _Nature Reviews Neuroscience_ — sleep memory function review; NREM/REM functional distinction
- Wilson & McNaughton (1994) — first demonstration of hippocampal sequence replay during sleep
- Kirkpatrick et al. (2017), _PNAS_ — EWC; neocortical consolidation analog
- Shin et al. (2017), _NeurIPS_ — deep generative replay; hippocampal replay ML analog
- van de Ven, Siegelmann, Tolias (2020), _Nature Communications_ — brain-inspired replay; best biologically-faithful implementation
- Hayes & Krishnan et al. (2021), _Neural Computation_ — missing biological elements in DL replay; critical enumeration
- Tadros et al. (2022), _Nature Communications_ — sleep-like unsupervised replay with Hebbian plasticity; benchmark results
- Wang et al. (2025), _ACM CSUR_ — comprehensive survey of continual learning in LLMs
- arXiv 2603.14517 "SleepGate/Learning to Forget" — sleep-inspired KV cache management; small-model toy results (793K params)
