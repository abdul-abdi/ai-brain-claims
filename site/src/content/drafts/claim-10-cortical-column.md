---
title: "Claim 10 — Cortical Column ≈ Transformer Block"
type: research-claim
tags:
  [
    ai,
...
created: 2026-05-09
verdict: "weak form: supported as productive analogy with caveats; strong form (theorem-like Turing-equivalence): unsupported"
personas: [joscha-bach, bryan-cantrill]
---

# Claim 10: Cortical Column ≈ Transformer Block
...
## 1. The Unit Is Contested Before the Comparison Begins
...
### 1.1 Mountcastle's Original Proposal
...
### 1.2 Horton and Adams 2005: The Unit Without a Function
...
### 1.3 Cell-Type Heterogeneity Across Areas
...
## 2. What the Canonical Microcircuit Does Offer: The Douglas-Martin-Bastos Line

Setting aside the species-variation problem, a well-characterized circuit motif has been proposed and modeled.

### 2.1 Douglas and Martin's Canonical Microcircuit (1989)
...
### 2.2 Bastos et al. 2012: Predictive Coding on the Canonical Microcircuit
...
## 3. Where the Analogy Has Genuine Traction

Despite the mismatches, three computational primitives do appear in both systems:

### 3.1 Competitive Selection / Soft Attention
...
### 3.2 Recurrent Integration and Residual Streaming
...
### 3.3 Feedforward Nonlinear Transformation
...
## 4. Hawkins' Thousand Brains Theory: A Separate Claim
...
## 5. The Tolman-Eichenbaum Machine: A Useful Comparator
...
## 6. On Turing-Equivalence: Why the Strong Form Is a Low and Unhelpful Bar
...
### 7.1 Joscha Bach (Functionalism, Cognitive Architectures)
...
### 7.2 Bryan Cantrill (Systems Realism, Observability)
...
- Bricken et al. [unverified — specific paper on attention-like mechanisms in cortex not located in search]
- Linsker, R. [unverified — specific canonical microcircuit paper not located in search]
